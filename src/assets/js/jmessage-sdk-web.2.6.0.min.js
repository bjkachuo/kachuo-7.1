  ...
  function(t, e) {
    ...
    function() {
      return function(t) {
        ...
        function(t, e, n) {
          ...
          l.prototype.init = function(t) {
            ...
            t.flag !== s.SYNC_TYPE_OPEN && t.flag !== s.SYNC_TYPE_CLOSE || (e.channel.sync_type = t.flag),
              ...
              new a(this.channel).setEvent(s.EVENTS.INIT).setData(t).send().addHook(function(n, o) {
            ...
            l.prototype._initConversation = function() {
              ...
              null === e && (e = JSON.stringify({}), h.StorageUtils.addItem(t.channel.conversations_key, e)),
            ...
            l.prototype.register = function(t) {
              ...
              t.is_md5 || (t.password = p(t.password)),
                new a(this.channel).setEvent(s.EVENTS.REGISTER).setData(t).send()
            },
            l.prototype.getUserInfo = function(t) {
              return this.__checkLogin(),
              h.StringUtils.isBlack(t.appkey) && (t.appkey = this.current_appkey),
                new a(this.channel).setEvent(s.EVENTS.GET_ACROSS_USER_INFO).setData(t).send()
            },
            l.prototype.updateSelfInfo = function(t) {
              return this.__checkLogin(),
              h.StringUtils.isBlack(t.avatar) || delete t.avatar,
                new a(this.channel).setEvent(s.EVENTS.UPDATE_SELF_INFO).setData(t).send()
            },
            ...
            l.prototype.updateSelfPwd = function(t) {
              ...
              t.is_md5 || (t.old_pwd = p(t.old_pwd), t.new_pwd = p(t.new_pwd)),
                new a(this.channel).setEvent(s.EVENTS.UPDATE_SELF_PWD).setData(t).send()
            },
            l.prototype.getConversation = function() {
              ...
              return new a(this.channel).setEvent(s.EVENTS.GET_CONVERSATIONS).setData({}).send().addHook(function(e, n) {
                e.conversations.forEach(function(e) {
                  ...
                  h.StorageUtils.addItem(t.channel.conversations_key, JSON.stringify(t.conversations)),
                n && n(e)
              })
            },
            ...
            l.prototype.msgRetract = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.MSG_RETRACT).setData(t).send()
            },
            ...
            l.prototype.exitGroup = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.EXIT_GROUP).setData(t).send()
            },
            l.prototype.getGroups = function() {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.GET_GROUPS_LIST).setData({}).send().addHook(function(t, e) {
            ...
            l.prototype.getGroupInfo = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.GET_GROUP_INFO).setData(t).send().addHook(function(t, e) {
            ...
            l.prototype.addGroupMembers = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.ADD_ACROSS_GROUP_MEMBER).setData(t).send()
            },
            l.prototype.delGroupMembers = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.DEL_ACROSS_GROUP_MEMBER).setData(t).send()
            },
            l.prototype.getNoDisturb = function() {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.NO_DISTURB).setData({
                  version: 0
            ...
            l.prototype.addSingleNoDisturb = function(t) {
              return this.__checkLogin(),
                t.version = 0,
                new a(this.channel).setEvent(s.EVENTS.ADD_MSG_NO_DISTURB_SINGLE).setData(t).send()
            },
            l.prototype.delSingleNoDisturb = function(t) {
              return this.__checkLogin(),
                t.version = 0,
                new a(this.channel).setEvent(s.EVENTS.DELETE_MSG_NO_DISTURB_SINGLE).setData(t).send()
            },
            l.prototype.addGroupNoDisturb = function(t) {
              return this.__checkLogin(),
                t.version = 0,
                new a(this.channel).setEvent(s.EVENTS.ADD_MSG_NO_DISTURB_GROUP).setData(t).send()
            },
            l.prototype.delGroupNoDisturb = function(t) {
              return this.__checkLogin(),
                t.version = 0,
                new a(this.channel).setEvent(s.EVENTS.DELETE_MSG_NO_DISTURB_GROUP).setData(t).send()
            },
            l.prototype.addGlobalNoDisturb = function() {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.ADD_MSG_NO_DISTURB_GLOBAL).setData({
                  version: 0
                }).send()
            },
            l.prototype.delGlobalNoDisturb = function() {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.DELETE_MSG_NO_DISTURB_GLOBAL).setData({
                  version: 0
                }).send()
            },
            l.prototype.getBlacks = function() {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.GET_BLACK_LIST).setData({
                  version: 0
                }).send()
            },
            l.prototype.addSingleBlacks = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.ADD_BLACK_LIST).setData(t).send()
            },
            l.prototype.delSingleBlacks = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.DEL_BLACK_LIST).setData(t).send()
            },
            ...
            l.prototype.addFriend = function(t) {
              return this.__checkLogin(),
                ...
                new a(this.channel).setEvent(s.EVENTS.ADD_FRIEND).setData(t).send()
            },
            ...
            l.prototype.delFriend = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.DEL_FRIEND).setData(t).send()
            },
            l.prototype.updateFriendMemo = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.UPDATE_FRIEND_MEMO).setData(t).send()
            },
            l.prototype.addGroupShield = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.ADD_MSG_SHIELD_GROUP).setData(t).send()
            },
            l.prototype.delGroupShield = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.DEL_MSG_SHIELD_GROUP).setData(t).send()
            },
            l.prototype.groupShieldList = function() {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.LIST_SHIELD_GROUP).setData({}).send().addHook(function(t, e) {
            ...
            l.prototype.getResource = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.GET_RESOURCE).setData(t).send()
            },
            l.prototype._updateGroupUnreadCount = function(t) {
              this.__checkLogin(),
                t.type = 4,
                new a(this.channel).setEvent(s.EVENTS.UNREAD_GROUP_COUNT).setData(t).send()
            },
            l.prototype._updateSingleUnreadCount = function(t) {
              this.__checkLogin(),
                t.type = 3,
                new a(this.channel).setEvent(s.EVENTS.UNREAD_SINGLE_COUNT).setData(t).send()
            },
            l.prototype.msgUnreadList = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.MSG_UNREAD_LIST).setData(t).send()
            },
            ...
            l.prototype.transSingleMsg = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.TRANS_MSG_SINGLE).setData(t).send()
            },
            l.prototype.transGroupMsg = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.TRANS_MSG_GROUP).setData(t).send()
            },
            l.prototype.transPlatMsg = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.TRANS_MSG_PLATFORM).setData(t).send()
            },
            ...
            l.prototype.addGroupMemberResp = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.ADMIN_ADD_GROUP_MEMBER).setData(t).send()
            },
            l.prototype.joinGroup = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.APPLY_JOIN_GROUP).setData(t).send()
            },
            l.prototype.getAppkeyChatrooms = function(t) {
              return this.__checkLogin(),
              !t && (t = {}),
                new a(this.channel).setEvent(s.EVENTS.ROOM_LIST).setData(t).send().addHook(function(t, e) {
            ...
            l.prototype.getSelfChatrooms = function() {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.ROOM_LIST_SELF).setData({}).send().addHook(function(t, e) {
            ...
            l.prototype.getChatroomInfo = function(t) {
              ...
              return h.Cache.rooms[t.id] ? setTimeout(function() {
                ...
                h.Cache.rooms[t.info.id] = t.info,
                e && e(t)
              }),
                e
            },
            l.prototype.enterChatroom = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.JOIN_ROOM).setData(t).send()
            },
            l.prototype.exitChatroom = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.EXIT_ROOM).setData(t).send()
            },
            l.prototype.sendChatroomMsg = function(t) {
              return this.__checkLogin(),
              t.target_rname || (t.target_rname = void 0 === h.Cache.rooms[t.target_rid] ? "": h.Cache.rooms[t.target_rid].name),
                this.__sendMsg({
                  type: "chatroom",
            ...
            l.prototype.addGroupMemSilence = function(t) {
              return this.__checkLogin(),
                t.keep_silence = !0,
                new a(this.channel).setEvent(s.EVENTS.GROUP_MEM_SILENCE).setData(t).send()
            },
            ...
            l.prototype.dissolveGroup = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.DISSOLVE_GROUP).setData(t).send()
            },
            l.prototype.addGroupKeeper = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.ADD_GROUP_KEEPER).setData(t).send()
            },
            l.prototype.delGroupKeeper = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.DEL_GROUP_KEEPER).setData(t).send()
            },
            l.prototype.changeGroupAdmin = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.CHANGE_GROUP_ADMIN).setData(t).send()
            },
            l.prototype.getAppkeyPublicGroups = function(t) {
              return this.__checkLogin(),
                new a(this.channel).setEvent(s.EVENTS.PUBLIC_GROUP_LIST).setData(t).send().addHook(function(t, e) {
              ...
              Array.prototype.push.apply([], t.messages.map(function(t) {
                ...
                t.messages.forEach(function(t) {
                  ...
                  e.conversations[o] || (e.conversations[o] = {},
                    ...
                    e.current_conversation === o || r ? (e.conversations[o].recent_time = t.ctime_ms, e.conversations[o].unread_msg_count = 0, e.conversations[o].msg_time = []) : (e.conversations[o].unread_msg_count = e.conversations[o].unread_msg_count + 1, e.conversations[o].msg_time.push(t.ctime_ms)),
            ...
            l.prototype._onSyncEvent = function(t) {
              ...
              new a(e.channel).setEvent(s.EVENTS.SYNC_EVENT_ACK).setData(n).send(),
                setTimeout(function() {
                    if (e._onSyncEventFn && t.events && t.events.length > 0) {
                      ...
                      t.events.forEach(function(o) {
                        if (200 === o.event_type) 3 === o.description.type ? e._dealMutlReadEvent(o.description.type, o.ctime_ms, o.description.appkey, o.description.username) : e._dealMutlReadEvent(o.description.type, o.ctime_ms, o.description.gid);
                          ...
                          56 === t.event_type && 10 == t.extra ? (delete r.extra, r.by_self = !1) : 56 === t.event_type && 59 == t.extra && (delete r.extra, r.by_self = !0),
                            n.push(r)
                        }
                      }),
                        e._onSyncEventFn(n)
          ...
          l.prototype._dealMutlReadEvent = function(t, e, n, o) {
            ...
            if (s.type = t, 3 === t ? (r = n + o, s.username = o, s.appkey = n) : (r = String(n), s.gid = n), i.conversations[r] = void 0 === i.conversations[r] ? {
              msg_time: [],
              unread_msg_count: 0
            }: i.conversations[r], i.conversations[r].recent_time = e, i.current_conversation === r) i.conversations[r].unread_msg_count = 0,
              ...
              u < a && (i.conversations[r].unread_msg_count = u, s.unreadCount = u, h.StorageUtils.addItem(i.channel.conversations_key, JSON.stringify(i.conversations)), i._conversationUpdateFun && i._conversationUpdateFun(s))
            }
          },
          l.prototype._receiptReport = function() {
            if (this.report.length > 0) {
              ...
              this.report.forEach(function(n) {
                ...
                } else t[n.args.key] = String(e.length),
                  e.push({
                    result: n.args,
                    msg_reports: [n]
                  })
          ...
          l.prototype.__getUploadToken = function() {
            return this.__checkLogin(),
              new a(this.channel).setEvent(s.EVENTS.GET_UPLOAD_TOKEN).setData({}).send()
          },
              ...
              function() {
                ...
                p.defer = c,
                  ...
                  p.onerror = function(t) {
                    throw console.error("Thenjs caught error: ", t),
                      t
                  };
                var h = p.prototype;
                function l() {
                  var t = this,
                    e = s(arguments); ! 1 !== t._result && (!t._result && t._chain && t.debug.apply(t, ["\nChain " + t._chain + ": "].concat(s(e))), t._result = !1, a(function(n) {
                      n === e[0] ?
                        function(t, e) {
                          var n = t,
                            o = t._error || t._finally;
                          for (; ! o && n._nextThen;) n = n._nextThen,
                            o = n._error || n._finally;
                ...
                function _(t, e, n) {
                  var o = new p;
                  return t(d(o, n), e),
                    e ? (e._nextThen = o, e._chain && (o._chain = e._chain + 1), e._result && r(function() {
                      l.apply(e, e._result)
                    }), o) : o
                }
                function y(t, e) {
        ...
        function(t, e, n) { !
          function() {
            ...
            t.atob || (t.atob = function(t) {
              ...
              for (var r, i, s = 0,
                     a = 0,
                     c = ""; i = e.charAt(a++);~i && (r = s % 4 ? 64 * r + i: i, s++%4) ? c += String.fromCharCode(255 & r >> ( - 2 * s & 6)) : 0) i = n.indexOf(i);
              return c
            })
          } ()
        },
          ...
          s.prototype.init = function(t) {
            ...
            s.prototype.onReceive = function(t, e) {
              if (this.opts.debug && console.info("---<- event:%s, data:%s", t, JSON.stringify(e)), t !== i.EVENTS.EVENT_NOTIFICATION && t !== i.EVENTS.MSG_SYNC && t !== i.EVENTS.SYNC_CONVERSATION && t !== i.EVENTS.SYNC_EVENT && t !== i.EVENTS.SYNC_RECEIPT && t !== i.EVENTS.RECEIPT_CHANGE && t !== i.ROOM_MSG_SYNC && t !== i.ROOM_MSG_SYNC_HIS) {
                ...
                delete e.rid,
                n && (0 === e.code && t === i.EVENTS.GET_GROUP_MEMBERS ? e.member_list.forEach(function(t) {
          ...
          t.exports = o,
            ...
            o.prototype.emit = function(t) {
              ...
              var e = [].slice.call(arguments, 1),
                n = this._callbacks["$" + t];
              if (n) for (var o = 0,
                            r = (n = n.slice(0)).length; o < r; ++o) n[o].apply(this, e);
              return this
            },
        ...
        function(t, e, n) {
          ...
          function c(t, e) {
            ...
            var n, r = o(t),
              ...
              p = r.path,
              h = a[u] && p in a[u].nsps;
            return e.forceNew || e["force new connection"] || !1 === e.multiplex || h ? (s("ignoring socket cache for %s", c), n = i(c, e)) : (a[u] || (s("new io instance for %s", c), a[u] = i(c, e)), n = a[u]),
              r.query && !e.query ? e.query = r.query: e && "object" == typeof e.query && (e.query = function(t) {
                var e = [];
        ...
        function(t, e) {
          ...
          t.exports = function(t) {
            ...
            for (var s = n.exec(t || ""), a = {},
                   c = 14; c--;) a[o[c]] = s[c] || "";
            return - 1 != r && -1 != i && (a.source = e, a.host = a.host.substring(1, a.host.length - 1).replace(/;/g, ":"), a.authority = a.authority.replace("[", "").replace("]", "").replace(/;/g, ":"), a.ipv6uri = !0),
              a
          }
        },
        function(t, e, n) { (function(o) {
          function r() {
            try {
        ...
        function(t, e, n) { (e = t.exports = i.debug = i).coerce = function(t) {
        ...
        function(t, e, n) {
          ...
          e.protocol = 4,
            ...
            e.Encoder = c,
            e.Decoder = p,
            c.prototype.encode = function(t, n) { (o("encoding packet %j", t), e.BINARY_EVENT == t.type || e.BINARY_ACK == t.type) ?
              function(t, e) {
                s.removeBlobs(t,
                  function(t) {
        ...
        function(t, e, n) { (e = t.exports = function(t) {
          function n() {}
          function i() {
            var t = i,
              n = +new Date,
          ...
          t.exports = function(t, e) {
            return e = e || {},
              "string" == typeof t ?
                ...
                e.long ? a(u = t, i, "day") || a(u, r, "hour") || a(u, o, "minute") || a(u, n, "second") || u + " ms": (c = t) >= i ? Math.round(c / i) + "d": c >= r ? Math.round(c / r) + "h": c >= o ? Math.round(c / o) + "m": c >= n ? Math.round(c / n) + "s": c + "ms";
            var c, u
          }
        },
        function(t, e, n) {
          var o; (function(t, r) { (function() {
            var i = n(20),
              s = {
                function: !0,
                object: !0
              ...
              if (!v("json")) {
                ...
                if ((f = y.hasOwnProperty) || (f = function(t) {
                  ...
                  return n = o = null,
                    i ? d = 2 == i ?
                      function(t, e) {
                        ...
                        for (n in t) r && "prototype" == n || !f.call(t, n) || (o = "constructor" === n) || e(n); (o || f.call(t, n = "constructor")) && e(n)
                    ...
                    D = function(t, e, n, o, r, i, s) {
                      ...
                      if ("object" == typeof a) {
                        ...
                        if (s.push(a), w = [], L = i, i += r, c == T) {
                          for (I = 0, x = a.length; I < x; I++) C = D(I, a, n, o, r, i, s),
                            w.push(C === _ ? "null": C);
                          M = w.length ? r ? "[\n" + i + w.join(",\n" + i) + "\n" + L + "]": "[" + w.join(",") + "]": "[]"
                        } else d(o || a,
                          function(t) {
                  ...
                  e.stringify = function(t, e, n) {
                    ...
                    if (s[typeof e] && e) if ((a = g.call(e)) == E) r = e;
                      ...
                      i = {};
                      for (var c, u = 0,
                             p = e.length; u < p; c = e[u++], ((a = g.call(c)) == S || a == k) && (i[c] = 1));
                    }
                ...
                if (!v("json-parse")) {
                  var I, x, L = o.fromCharCode,
                    ...
                    U = function() {
                      for (var t, e, n, o, r, i = x,
                             s = i.length; I < s;) switch (r = i.charCodeAt(I)) {
                        case 9:
                        case 10:
                        case 13:
                        case 32:
                        ...
                        default:
                          ...
                          if (o && P(), "true" == i.slice(I, I + 4)) return I += 4,
                            !0;
                          if ("false" == i.slice(I, I + 5)) return I += 5,
                            !1;
                          if ("null" == i.slice(I, I + 4)) return I += 4,
                            null;
                          P()
                      }
                      return "$"
                    ...
                    G = function(t) {
                      ...
                      if ("$" == t && P(), "string" == typeof t) {
                        ...
                        if ("{" == t) {
                          for (e = {};
                               "}" != (t = U()); n || (n = !0)) n && ("," == t ? "}" == (t = U()) && P() : P()),
                          "," != t && "string" == typeof t && "@" == (b ? t.charAt(0) : t[0]) && ":" == U() || P(),
                            e[t.slice(1)] = G(U());
                          return e
                        }
                        P()
            ...
            if (!u || u.global !== u && u.window !== u && u.self !== u || (c = u), a && !i) p(c, a);
              ...
              var h = c.JSON,
                ...
                d = p(c, c.JSON3 = {
                  noConflict: function() {
                    return f || (f = !0, c.JSON = h, c.JSON3 = l, h = l = null),
                      d
                  }
                });
              c.JSON = {
        ...
        function(t, e, n) {
          ...
          t.exports = f,
            ...
            f.prototype.maybeReconnectOnOpen = function() { ! this.reconnecting && this._reconnection && 0 === this.backoff.attempts && this.reconnect()
            },
            ...
            f.prototype.destroy = function(t) {
              var e = p(this.connecting, t);~e && this.connecting.splice(e, 1),
        ...
        function(t, e, n) { (function(e) {
          ...
          function h(t, n) {
            ...
            t && "object" == typeof t && (n = t, t = null),
              t ? (t = c(t), n.hostname = t.host, n.secure = "https" === t.protocol || "wss" === t.protocol, n.port = t.port, t.query && (n.query = t.query)) : n.host && (n.hostname = c(n.host).host),
          ...
          t.exports = h,
            ...
            h.prototype.sendPacket = function(t, e, n, o) {
              if ("function" == typeof e && (o = e, e = void 0), "function" == typeof n && (o = n, n = null), "closing" !== this.readyState && "closed" !== this.readyState) { (n = n || {}).compress = !1 !== n.compress;
                var r = {
                  type: t,
                  data: e,
                  options: n
          ...
          t.exports = u,
            ...
            p.prototype.cleanup = function(t) {
              if (void 0 !== this.xhr && null !== this.xhr) {
                ...
                e.document && delete p.requests[this.index],
                  this.xhr = null
              }
            },
            ...
            p.requestsCount = 0,
            p.requests = {},
          e.document && (e.attachEvent ? e.attachEvent("onunload", h) : e.addEventListener && e.addEventListener("beforeunload", h, !1))
        }).call(e, window)
        },
        function(t, e, n) {
          var o = n(34),
          ...
          s(p, o),
            ...
            p.prototype.pause = function(t) {
              ...
              if (this.readyState = "pausing", this.polling || !this.writable) {
                var o = 0;
                this.polling && (c("we are currently polling - waiting to pause"), o++, this.once("pollComplete",
                  function() {
                    c("pre-pause polling complete"),
                    --o || n()
                  })),
                this.writable || (c("we are currently writing - waiting to pause"), o++, this.once("drain",
                  function() {
            ...
            p.prototype.onData = function(t) {
              ...
              i.decodePayload(t, this.socket.binaryType,
                function(t, n, o) {
        ...
        function(t, e, n) { (function(t) {
          ...
          e.encodePacket = function(n, o, r, i) {
            ...
            if (p && p.base64) return s = n,
              a = i,
              u = "b" + e.packets[s.type] + s.data.data,
              a(u);
            var f = l[n.type];
            return void 0 !== n.data && (f += r ? c.encode(String(n.data)) : String(n.data)),
              i("" + f)
          },
          ...
          var o; (function(t, r) { !
            function(i) {
              ...
              function d(t) {
                ...
                var e = "";
                return 0 == (4294965248 & t) ? e = h(t >> 6 & 31 | 192) : 0 == (4294901760 & t) ? (e = h(t >> 12 & 15 | 224), e += f(t, 6)) : 0 == (4292870144 & t) && (e = h(t >> 18 & 7 | 240), e += f(t, 12), e += f(t, 6)),
                  e += h(63 & t | 128)
              }
              function _() {
                ...
                decode: function(t) {
                  ...
                  return function(t) {
                    for (var e, n = t.length,
                           o = -1,
                           r = ""; ++o < n;)(e = t[o]) > 65535 && (r += h((e -= 65536) >>> 10 & 1023 | 55296), e = 56320 | 1023 & e),
                      r += h(e);
                    return r
                  } (n)
                }
        ...
        function(t, e) { !
          function() {
            ...
            for (var t = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
                   n = new Uint8Array(256), o = 0; o < t.length; o++) n[t.charCodeAt(o)] = o;
            e.encode = function(e) {
              var n, o = new Uint8Array(e),
                r = o.length,
                i = "";
              for (n = 0; n < r; n += 3) i += t[o[n] >> 2],
                i += t[(3 & o[n]) << 4 | o[n + 1] >> 4],
          ...
          r(u, o),
            ...
            u.prototype.doWrite = function(t, e) {
              ...
              function p() {
                ...
                } catch(t) { (o = document.createElement("iframe")).name = n.iframeId,
                  o.src = "javascript:0"
                }
                o.id = n.iframeId,
                  n.form.appendChild(o),
                  n.iframe = o
              }
          ...
          h || "undefined" != typeof window || (h = o),
            ...
            l.prototype.write = function(t) {
              ...
              for (var o = t.length,
                     ...
                     s = o; r < s; r++) !
                function(t) {
                  i.encodePacket(t, n.supportsBinary,
                    function(r) {
        ...
        function(t, e, n) {
          ...
          r(l.prototype),
            ...
            l.prototype.emit = function(t) {
              if (p.hasOwnProperty(t)) return h.apply(this, arguments),
                this;
              var e = i(arguments),
                n = o.EVENT;
            ...
            function l(t, e) {
              return function(t, e) {
                var n, o, r = c(t),
                  i = [],
                  u = [];
                for (i[15] = u[15] = void 0, r.length > 16 && (r = s(r, 8 * t.length)), n = 0; n < 16; n += 1) i[n] = 909522486 ^ r[n],
                  u[n] = 1549556828 ^ r[n];
                return o = s(i.concat(c(e)), 512 + 8 * e.length),
                  a(s(u.concat(o), 640))
              } (p(t), p(e))
            }
          ...
          var n = {
            ...
            o = {
              ...
              removeItems: function(t) {
                if (window.localStorage) {
                  for (var e = localStorage.length,
                         n = [], o = 0; o < e; o++) localStorage.getItem(localStorage.key(o)) === t && n.push(localStorage.key(o));
            ...
            r = {
              delRepeatItem: function(t) {
                var e = [];
                return t.forEach(function(t) { - 1 === e.indexOf(t) && null != t && e.push(t)
                }),
                  e
              }
            },
