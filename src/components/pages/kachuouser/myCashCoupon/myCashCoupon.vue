          ...
          <div class="swiper-item">
            <div class="list-item" v-for="(item2,index2) in item" :key="index+'_'+index2">
              ...
              <div class="border-box" v-if="item2.Status == 1">
                <div class="btn-menu" @click="refund">查看详情</div>
              </div>
            </div>
          </div>
        </scroller>
  ...
  export default {
    ...
    data() {
      return {
        ...
        tabList: [{name:'待支付',id: 1,PageIndex:1},{name:"待出行",id:2,PageIndex:1}, {name:"已使用",id:3,PageIndex:1},{name:"退款中",id:4,PageIndex:1},{name:"已取消",id:5,PageIndex:1}],
        index: 0,
        iscur: 0,
        dataList: [],
        getData: [],
