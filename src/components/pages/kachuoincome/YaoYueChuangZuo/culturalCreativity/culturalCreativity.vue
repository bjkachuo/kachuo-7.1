...
<!--            <group title style="margin-top:10px">-->
              <x-input label-width="5em" :title='`<span style="${labelStyle}">作品名称：</span>`' ></x-input>
              <x-input label-width="5em" :title='`<span style="${labelStyle}">核心文化：</span>`' ></x-input>
              <x-input label-width="5em" :title='`<span style="${labelStyle}">创作元素：</span>`' ></x-input>
              <x-textarea title="时代精神：" :max="500"  :height="200" :rows="8" :cols="30"></x-textarea>
<!--            </group>-->
