<template>
  <div class="wrap">
    ...
    <div class="normal-content" :style="conHei">
        ...
        <div class="bs-panel">
          <div class="bs-panel-body">
            ...
            <div class="bs-raty">
              ...
              <rater v-model="this.starNum"  active-color="#ffc800" :margin="0" disabled :font-size="15"></rater>
            </div>
            <div class="bs-style">
      ...
      <div class="btn-space">
        <x-button class="btn-default" link="/GuideForm"><i class="icon-time"></i><span>预约导游</span></x-button>
      </div>
    </div>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    this.$http
      .post(
        "https://core.kachuo.com/app/ewei_shopv2_app.php?i=8&c=site&a=entry&m=ewei_shopv2&do=mobile&r=tourguide.index.detail&id="+this.$route.query.idNum
      )
      .then(({ data }) => {
        console.log(data);
        this.DList = data.data;
        console.log(this.DList)
        this.starNum = parseFloat(this.DList.score);
