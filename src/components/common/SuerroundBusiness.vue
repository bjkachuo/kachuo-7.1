...
export default {
  ...
  methods: {
    ...
    sort() {
      ...
      this.$http.post("https://core.kachuo.com/app/ewei_shopv2_app.php?i=5&c=site&a=entry&m=ewei_shopv2&do=mobile&r=scenic.index.around_service_list&type="+this.option2+"&"+"type_score="+this.option3)
      .then(({data})=>{
        // console.log(data)
        this.BusinessList = data.data.list
        console.log(this.BusinessList)
