      ...
      <div class="content-two">
        <div class="content-two-head">
          ...
          <div class="head-right">
            <popup-radio :options="this.checkList" v-model="option2" placeholder="排序">
...
export default {
  ...
  mounted() {
    ...
    //获取选择分类！
    this.$http
      .post("https://core.kachuo.com/app/ewei_shopv2_app.php?i=5&c=site&a=entry&m=ewei_shopv2&do=mobile&r=scenic.index.around_service")
      .then(({ data }) => {
    ...
    //获取商家列表！
    this.$http
      .post("https://core.kachuo.com/app/ewei_shopv2_app.php?i=5&c=site&a=entry&m=ewei_shopv2&do=mobile&r=scenic.index.around_service_list&type="+this.typeNum)
      .then(({ data }) => {
